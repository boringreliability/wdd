...
3. CONTEXT.md is active constraints / invariants only — never a log of completed Wards. Working memory is generated by \`wdd session\`.
...
- \`.wdd/CONTEXT.md\` — Active constraints / invariants only (max 200 lines). Not a diary.
